            ...
            <div class="card">
              <div class="card-body">
                <form class="form-signin" data-testid="form-employee">
                  ...
                  <input type="password" data-testid="employee-password-input" id="employee-password-input" autocomplete="on" class="form-control" placeholder="******" required>
            ...
            <div class="card">
              <div class="card-body">
                <form class="form-signin" data-testid="form-admin">
                  ...
                  <input id="admin-password-input" type="password" data-testid="admin-password-input" autocomplete="on" class="form-control" placeholder="******" required>
